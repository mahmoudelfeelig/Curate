...
| Video | Public YouTube or Vimeo; maximum five minutes; working demo plus problem, user, and importance | An approximately 88-second clean-revision silent cut and matching short voiceover script are ready; record/mix the supplied voiceover, then publish the narrated cut |
