export const GUIDED_PREVIEW_DISCLOSURE = "These exact native steps become the user-attested handoff record when you prepare it. This performs zero API writes and verifies zero recommendation outcomes. Each completion remains a later user attestation.";
