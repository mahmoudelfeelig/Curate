    ...
    <section className="passport-book section-book evidence-book curate-tune-book">
      ...
      <article className="passport-page left-page">
        ...
        <form className="evidence-form curate-goal-form" onSubmit={(event) => { event.preventDefault(); onAnalyze("before"); }}>
          ...
          <Field label="A few posts from your feed" hint="Paste just one YouTube, Bluesky, or Instagram link per line. No descriptions needed; add context after | only if you want to."><textarea rows="6" value={form.linksText} onChange={(event) => update("linksText", event.target.value)} disabled={busy} placeholder={"https://www.youtube.com/watch?v=…\nhttps://bsky.app/profile/…/post/…\nhttps://www.instagram.com/p/…"} /></Field>
