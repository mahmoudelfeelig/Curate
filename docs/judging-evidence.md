...
| AWS promotional credits | The [official FAQ](https://agentsforhumans.devpost.com/details/faqs) says registered participants may request $50; requests close September 11, 2026 at 12:00 p.m. PT, while supplies last, and remain subject to the promotional-credit terms | The bounded managed proof uses the entrant's AWS account under a fixed USD 5 alert budget. Credits and Budgets are not a hard cap; the application stack is torn down after evidence capture |
...
| Working access | Website, functioning demo, or test build available free and unrestricted during judging | The credential-free build is live at [feed-passport.pages.dev](https://feed-passport.pages.dev/); recheck it from a signed-out browser immediately before submission and during judging |
...
| Working judge access | Verified on 13 September at [feed-passport.pages.dev](https://feed-passport.pages.dev/) | Recheck the canonical URL from a signed-out browser immediately before submission and keep it available through October 8 |
