...
export function previewFixtureMission(spec, context) {
  ...
  const mission = {
    ...
    fidelity_disclaimer: "This practice feed models the controls Curate can use; it does not copy the app's private ranking system.",
    trace: [
      { stage: "observe", status: "completed", detail: "Read the practice feed's starting mix." },
      { stage: "evaluate", status: "completed", detail: "Measured the starting feed against the active Passport." },
      { stage: "plan", status: "completed", detail: `Prepared ${actions.length} reversible changes for the practice feed.` },
