...
const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description:
      "Observe a seeded local platform control twin, compile a bounded mission, and open the consent checkpoint. This never accesses a social account or grants approval.",
    inputSchema: {
      type: "object",
