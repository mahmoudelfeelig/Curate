...
| External live accounts | Candidate transports and the internal YouTube/Bluesky commission seam are source- and contract-tested; generic migrations cannot execute live adapters, no account/receipt proof exists, and the commission has no owner-authenticated public route | Never imply an OAuth registration, connection, Guided user attestation, local Instagram export, or commission plan was a provider action. Add only fresh authorized-dummy-account conformance receipts and keep unsupported platforms Guided |
