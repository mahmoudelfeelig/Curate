...
| Video | Public YouTube or Vimeo; maximum five minutes; working demo plus problem, user, and importance | An approximately 186-second clean-revision tutorial cut and matching voiceover script show the complete before/request/agent/result flow; record or supply the voiceover, then publish the narrated cut |
