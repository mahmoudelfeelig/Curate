...
Curate turns natural-language feed intent into a portable Passport. This one-minute demonstration shows a broad request, an exact seven-topic mix, a local Strands plan, a bounded practice run, six visible starting and curated posts, and verified rollback.
